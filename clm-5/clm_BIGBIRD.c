/* translate bigbird in naive.lisp to C
...
int clm_bigbird4 (double *clm_double, int datar_len, int *clm_int, int datai_len)
{
  /* The _clm_* variables are temporary values generated by the run macro */
  void (*old_SIGINT)(int);
  mus_long_t I;
  double _clm_5226, _clm_5227, _clm_5228, _clm_5229, _clm_5230, _clm_5231;
...
SAMPLE_LOOP_BEGIN:
  ...
  if (I > clm_end) {I = clm_end; goto RUN_ALL_DONE;}
                                                                                /* (progn */
  _clm_5229 = mus_env(AMP_ENV);                                                 /* (env AMP-ENV) */
  _clm_5231 = mus_env(GLS_ENV);                                                 /* (env GLS-ENV) */
  _clm_5230 = mus_polyshape(OS, 1.0, _clm_5231);                                /* (polyshape OS 1.0 _clm_5231) */
                                                                                /* (* _clm_5229 _clm_5230) */
  _clm_5228 = ((_clm_5229) * (_clm_5230));
  _clm_5227 = mus_one_pole(FIL, _clm_5228);                                     /* (one-pole FIL _clm_5228) */
  _clm_5226 = clm_locsig(LOC, I, _clm_5227);
